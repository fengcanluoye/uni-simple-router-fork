;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['Router'] = factory()
  ...
  \*******************************/
        ...
        /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          var base_1 = __webpack_require__(
            /*! ../options/base */ './src/options/base.ts',
          )
          var warn_1 = __webpack_require__(
            /*! ../helpers/warn */ './src/helpers/warn.ts',
          )
          var utils_1 = __webpack_require__(
            /*! ../helpers/utils */ './src/helpers/utils.ts',
          )
          var hooks_1 = __webpack_require__(
            /*! ../public/hooks */ './src/public/hooks.ts',
          )
          function buildVueRoutes(router, vueRouteMap) {
            var _a = router.routesMap,
              pathMap = _a.pathMap,
              finallyPathList = _a.finallyPathList
            ...
            for (var i = 0; i < vueRoutePathList.length; i++) {
              ...
              if (!myRoute) {
                warn_1.warn(
                  path +
                    ' \u8DEF\u7531\u5730\u5740\u5728\u8DEF\u7531\u8868\u4E2D\u672A\u627E\u5230\uFF0C\u786E\u5B9A\u662F\u5426\u4F20\u9012\u6F0F\u5566',
                  router,
                  true,
                )
              } else {
                var finallyPath = utils_1.getRoutePath(myRoute, router)
                  .finallyPath
                if (finallyPath instanceof Array) {
                  throw new Error(
                    '\u975E vueRouterDev \u6A21\u5F0F\u4E0B\uFF0Calias\u3001aliasPath\u3001path \u65E0\u6CD5\u63D0\u4F9B\u6570\u7EC4\u7C7B\u578B\uFF01 ' +
                ...
                if (beforeEnter) {
                  vueRoute['beforeEnter'] = function (to, from, next) {
                    hooks_1.onTriggerEachHook(
                      to,
                      from,
                      router,
                      base_1.hookToggle['enterHooks'],
                      next,
                    )
                  }
                }
          ...
          function buildVueRouter(router, vueRouter, vueRouteMap) {
            ...
            var newVueRouter = new vueRouter.constructor(
              __assign(__assign({}, router.options.h5), {
        ...
        /***/ function (__unused_webpack_module, exports) {
          ...
          function proxyEachHook(router, vueRouter) {
            ...
            for (var i = 0; i < hookList.length; i++) {
              ...
              if (myEachHook) {
                ...
                vueRouter[hookName] = new MyArray(
                  router,
                  vueEachArray,
                  myEachHook,
                  hookName,
          ...
          function proxyH5Mount(router) {
            ...
            if (router.mount.length === 0) {
              if (
                (_a = router.options.h5) === null || _a === void 0
                  ? void 0
                  : _a.vueRouterDev
              ) {
                return
  ...
  \*****************************/
        ...
        /***/ function (__unused_webpack_module, exports) {
          ...
          function registerLoddingPage(router) {
            var _a
            if (
              (_a = router.options.APP) === null || _a === void 0
                ? void 0
                : _a.registerLoadingPage
            ) {
              var _b = router.options.APP,
                loadingPageHook = _b.loadingPageHook,
                loadingPageStyle = _b.loadingPageStyle // 获取app所有配置
              var view = new plus.nativeObj.View(
                'router-loadding',
                __assign(
          ...
          function tabIndexSelect(to, from) {
            if (
              !(__uniConfig.tabBar && Array.isArray(__uniConfig.tabBar.list))
            ) {
              return false
            }
            ...
            for (var i = 0; i < tabBarList.length; i++) {
              ...
              if (
                '/' + route.pagePath === to.path ||
                '/' + route.pagePath === from.path
              ) {
          ...
          function getEnterPath(vueVim, router) {
            switch (router.options.platform) {
              ...
              case 'mp-baidu':
                ...
                return (
                  vueVim.$options.mpInstance.is ||
                  vueVim.$options.mpInstance.pageinstance.route
                )
            }
  ...
  \*******************************/
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
          ...
          var warn_1 = __webpack_require__(
            /*! ./warn */ './src/helpers/warn.ts',
          )
          var query_1 = __webpack_require__(
            /*! ../public/query */ './src/public/query.ts',
          )
          exports.mpPlatformReg =
            '(^mp-weixin$)|(^mp-baidu$)|(^mp-alipay$)|(^mp-toutiao$)|(^mp-qq$)|(^mp-360$)' // 小程序下不能直接导出正则 需要重新组装成正则 不然bug一推 诡异
          exports.baseConfig = {
            h5: {
              paramsToQuery: false,
              vueRouterDev: false,
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
          ...
          function createRouteMap(router, routes) {
            ...
            routes.forEach(function (route) {
              var _a = utils_1.getRoutePath(route, router),
                finallyPath = _a.finallyPath,
                aliasPath = _a.aliasPath,
                path = _a.path
              if (path == null) {
                throw new Error(
                  '\u8BF7\u63D0\u4F9B\u4E00\u4E2A\u5B8C\u6574\u7684\u8DEF\u7531\u5BF9\u8C61\uFF0C\u5305\u62EC\u4EE5\u7EDD\u5BF9\u8DEF\u5F84\u5F00\u59CB\u7684 \u2018path\u2019 \u5B57\u7B26\u4E32 ' +
                    JSON.stringify(route),
                )
              }
              if (finallyPath instanceof Array) {
                if (
                  !router.options.h5.vueRouterDev &&
                  router.options.platform === 'h5'
                ) {
                  throw new Error(
                    '\u975E vueRouterDev \u6A21\u5F0F\u4E0B\uFF0Croute.alias \u76EE\u524D\u65E0\u6CD5\u63D0\u4F9B\u6570\u7EC4\u7C7B\u578B\uFF01 ' +
                      JSON.stringify(route),
                  )
                }
              }
  ...
  \**********************************/
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
          ...
          function registerRouterHooks(cycleHooks, options) {
            registerHook(cycleHooks.routerBeforeHooks, function (
              to,
              from,
              next,
            ) {
          ...
          function registerEachHooks(router, hookType, userGuard) {
            registerHook(router.lifeCycle[hookType], function (
              ...
              if (auto) {
                // h5端 vue-router自动触发 非自己调用触发
                hooks_1.onTriggerEachHook(
                  to,
                  from,
                  router,
                  base_1.hookToggle[hookType],
                  next,
                )
              } else {
  ...
  \*******************************/
        ...
        /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          var createRouteMap_1 = __webpack_require__(
            /*! ../helpers/createRouteMap */ './src/helpers/createRouteMap.ts',
          )
          var buildRouter_1 = __webpack_require__(
            /*! ../H5/buildRouter */ './src/H5/buildRouter.ts',
          )
          var proxyHook_1 = __webpack_require__(
            /*! ../H5/proxyHook */ './src/H5/proxyHook.ts',
          )
          var appPatch_1 = __webpack_require__(
            /*! ../app/appPatch */ './src/app/appPatch.ts',
          )
          var page_1 = __webpack_require__(
            /*! ../public/page */ './src/public/page.ts',
          )
          var methods_1 = __webpack_require__(
            /*! ../public/methods */ './src/public/methods.ts',
          )
          var utils_1 = __webpack_require__(
            /*! ./utils */ './src/helpers/utils.ts',
          )
          var appletPatch_1 = __webpack_require__(
            /*! ../applets/appletPatch */ './src/applets/appletPatch.ts',
          )
          var config_1 = __webpack_require__(
            /*! ./config */ './src/helpers/config.ts',
          )
          var beforeProxyHook_1 = __webpack_require__(
            /*! ../public/beforeProxyHook */ './src/public/beforeProxyHook.ts',
          )
                ...
                beforeCreate: function () {
                  ...
                  if (this.$options.router) {
                    ...
                    if (
                      ...
                      vueRouteMap = createRouteMap_1.createRouteMap(
                        router,
              ...
              'app-lets': {
                beforeCreate: function () {
                  ...
                  if (pageType === 'component') {
                    isProxy = utils_1.assertParentChild(
                      appletProxy['page'],
                      this,
                    )
                  } else {
                    if (pageType === 'page') {
                      appletProxy[pageType] = appletPatch_1.getEnterPath(
                        this,
                        router,
                      )
                ...
                onLoad: function () {
                  ...
                  if (
                    !onloadProxyOk &&
                    utils_1.assertParentChild(appletProxy['page'], this)
                  ) {
                    onloadProxyOk = true
          ...
          function initMixins(Vue, router) {
            var routesMap = createRouteMap_1.createRouteMap(
              router,
  ...
  \******************************/
        ...
        /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          var config_1 = __webpack_require__(
            /*! ../helpers/config */ './src/helpers/config.ts',
          )
          var hooks_1 = __webpack_require__(
            /*! ../public/hooks */ './src/public/hooks.ts',
          )
          ...
          var Regexp = __webpack_require__(
          ...
          function mergeConfig(baseConfig, userConfig) {
            ...
            var baseConfigKeys = Object.keys(baseConfig).concat([
              'resolveQuery',
              'parseQuery',
            ])
          ...
          function assertNewOptions(options) {
            ...
            if (platform == null) {
              throw new Error(
                "\u4F60\u5728\u5B9E\u4F8B\u5316\u8DEF\u7531\u65F6\u5FC5\u987B\u4F20\u9012 'platform'",
              )
            }
            if (routes == null || routes.length === 0) {
              throw new Error(
                '\u4F60\u5728\u5B9E\u4F8B\u5316\u8DEF\u7531\u65F6\u5FC5\u987B\u4F20\u9012 routes \u4E3A\u7A7A\uFF0C\u8FD9\u662F\u65E0\u610F\u4E49\u7684\u3002',
              )
            }
            if (options.platform === 'h5') {
              if (
                (_a = options.h5) === null || _a === void 0
                  ? void 0
                  : _a.vueRouterDev
              ) {
          ...
          function notRouteTo404(router, toRoute, parseToRule, navType) {
            ...
            var redirectRule = methods_1.navjump(
              newRoute,
              router,
              navType,
              undefined,
          ...
          function routesForMapRoute(router, path, mapArrayKey, deepFind) {
            ...
            for (var i = 0; i < mapArrayKey.length; i++) {
              ...
              for (
                var _i = 0, _b = Object.entries(mapList);
                _i < _b.length;
                _i++
              ) {
                var _c = _b[_i],
          ...
          function forMatNextToFrom(router, to, from) {
            var _a = [to, from],
              ...
              matFrom = _a[1]
            if (router.options.platform === 'h5') {
              var _b = router.options.h5,
                vueNext = _b.vueNext,
                vueRouterDev = _b.vueRouterDev
          ...
          function paramsToQuery(router, toRule) {
            ...
            if (getDataType(toRule) === '[object Object]') {
              var _b = toRule,
                name_1 = _b.name,
                params = _b.params,
                moreToRule = __rest(_b, ['name', 'params'])
              ...
              if (name_1 != null && paramsQuery != null) {
                ...
                if (finallyPath.includes(':')) {
                  // 动态路由无法使用 paramsToQuery
                  hooks_1.ERRORHOOK[0](
                    {
                      type: 2,
                      msg:
                  ...
                  return __assign(__assign({}, moreToRule), {
                    path: finallyPath,
                    query: paramsQuery,
                  })
                }
            ...
            if (source == null) {
              ...
              for (var _i = 0, _a = Object.keys(source); _i < _a.length; _i++) {
                ...
                if (typeof source[key] === 'object') {
                  target[dyKey] =
                    getDataType(source[key]) === '[object Array]' ? [] : {}
          ...
          function assertParentChild(parentPath, vueVim) {
            ...
            try {
              if (
                vueVim.$mp.page.is === parentPath ||
                vueVim.$mp.page.route === parentPath
              ) {
                return true
              }
            } catch (error) {
          ...
          function resolveAbsolutePath(path, router) {
            ...
            var relative = paramsArray[1]
              .replace(/\//g, '\\/')
              .replace(/\.\./g, '[^\\/]+')
              .replace(/\./g, '\\.')
            var relativeReg = new RegExp('^\\/' + relative + '$')
            var route = router.options.routes.filter(function (it) {
              return relativeReg.test(it.path)
            })
            if (route.length !== 1) {
              throw new Error(
                '\u3010' +
  ...
  \**********************/
        ...
        /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          __exportStar(
            __webpack_require__(/*! ./options/base */ './src/options/base.ts'),
            exports,
          )
          __exportStar(
            __webpack_require__(
              /*! ./options/config */ './src/options/config.ts',
            ),
            exports,
          )
          var appPatch_1 = __webpack_require__(
          ...
          Object.defineProperty(exports, 'runtimeQuit', {
            enumerable: true,
            get: function () {
              return appPatch_1.runtimeQuit
            },
          })
          var router_1 = __webpack_require__(
            /*! ./public/router */ './src/public/router.ts',
          )
          Object.defineProperty(exports, 'RouterMount', {
            enumerable: true,
            get: function () {
              return router_1.RouterMount
            },
          })
          Object.defineProperty(exports, 'createRouter', {
            enumerable: true,
            get: function () {
              return router_1.createRouter
            },
          })
          ...
          if (/[A-Z]/g.test(version)) {
            console.warn(
              '\u3010' +
                'UNI-SIMPLE-ROUTER'.toLocaleLowerCase() +
                ' \u63D0\u793A\u3011\uFF1A\u5F53\u524D\u7248\u672C ' +
                version.toLocaleLowerCase() +
                ' \u6B64\u7248\u672C\u4E3A\u6D4B\u8BD5\u7248\u3002\u6709BUG\u8BF7\u9000\u56DE\u6B63\u5F0F\u7248\uFF0C\u7EBF\u4E0A\u6B63\u5F0F\u7248\u672C\uFF1A' +
                '2.0.7',
            )
          }
  ...
  \*****************************/
        ...
        /***/ (__unused_webpack_module, exports) => {
          ...
          ;(function (navtypeToggle) {
            ...
            (navtypeToggle =
              exports.navtypeToggle || (exports.navtypeToggle = {})),
          )
  ...
  \*****************************/
        ...
        /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          var methods_1 = __webpack_require__(
            /*! ./methods */ './src/public/methods.ts',
          )
          var proxyHook_1 = __webpack_require__(
            /*! ../H5/proxyHook */ './src/H5/proxyHook.ts',
          )
          var patch_1 = __webpack_require__(
            /*! ../H5/patch */ './src/H5/patch.ts',
          )
          var appPatch_1 = __webpack_require__(
            /*! ../app/appPatch */ './src/app/appPatch.ts',
          )
          exports.ERRORHOOK = [
            function (error, router) {
              return router.lifeCycle.routerErrorHooks[0](error, router)
            },
          ]
          exports.HOOKLIST = [
            function (router, to, from, toRoute, next) {
              return callHook(
                router.lifeCycle.routerBeforeHooks[0],
                to,
                from,
                router,
                next,
            ...
            function (router, to, from, toRoute, next) {
              return callBeforeRouteLeave(router, to, from, next)
            },
            function (router, to, from, toRoute, next) {
              return callHook(
                router.lifeCycle.beforeHooks[0],
                to,
                from,
                router,
                next,
            ...
            function (router, to, from, toRoute, next) {
              return callHook(toRoute.beforeEnter, to, from, router, next)
            },
            function (router, to, from, toRoute, next) {
              return callHook(
                router.lifeCycle.afterHooks[0],
                to,
                from,
                router,
                next,
            ...
            function (router, to, from, toRoute, next) {
              ...
              router.runId++
              return callHook(
                router.lifeCycle.routerAfterHooks[0],
                to,
                from,
                router,
                next,
          ...
          function transitionTo(
            ...
            var _a = utils_1.forMatNextToFrom(router, to, from),
              matTo = _a.matTo,
              matFrom = _a.matFrom
            if (router.options.platform === 'h5') {
              loopCallHook(
              ...
              loopCallHook(
                callHookList.slice(0, 4),
                0,
                function () {
                  hookCB(function () {
                    loopCallHook(
                      callHookList.slice(4),
                      0,
                      utils_1.voidFun,
                      router,
                      matTo,
          ...
          function loopCallHook(
            ...
            var toRoute = utils_1.routesForMapRoute(router, matTo.path, [
              'finallyPathMap',
              'pathMap',
            ])
            ...
            hook(router, matTo, matFrom, toRoute, function (nextTo) {
              ...
              if (nextTo === false) {
                ...
                if (typeof nextTo === 'object') {
                  var type = nextTo.NAVTYPE,
                    moreTo = __rest(nextTo, ['NAVTYPE'])
                  newNextTo = moreTo
                  if (type != null) {
                    newNavType = type
                  }
                }
                methods_1.navjump(newNextTo, router, newNavType, {
                  from: matFrom,
                  next: next,
                })
              } else if (nextTo == null) {
  ...
  \*******************************/
        ...
        /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          var query_1 = __webpack_require__(
            /*! ./query */ './src/public/query.ts',
          )
          var utils_1 = __webpack_require__(
            /*! ../helpers/utils */ './src/helpers/utils.ts',
          )
          var hooks_1 = __webpack_require__(
            /*! ./hooks */ './src/public/hooks.ts',
          )
          var page_1 = __webpack_require__(
            /*! ../public/page */ './src/public/page.ts',
          )
          var hooks_2 = __webpack_require__(
            /*! ./hooks */ './src/public/hooks.ts',
          )
          function lockNavjump(to, router, navType, forceNav, animation) {
            utils_1.lockDetectWarn(
              router,
              to,
              navType,
              function () {
          ...
          function navjump(
            ...
            if (navType === 'back') {
              ...
              if (router.options.platform === 'h5') {
                ...
                // @ts-ignore
                var success =
                  (animation || { success: utils_1.voidFun }).success ||
                  utils_1.voidFun
                // @ts-ignore
                var complete =
                  (animation || { complete: utils_1.voidFun }).complete ||
                  utils_1.voidFun
            ...
            if (router.options.platform === 'h5') {
              ...
              if (nextCall != null) {
                ...
                nextCall.next(
                  __assign({ replace: navType !== 'push' }, parseToRule),
                )
              } else {
                ...
                if (navType === 'push' && Reflect.has(parseToRule, 'events')) {
                  ...
                  router.$route[navType](
                    parseToRule,
                    parseToRule.success || utils_1.voidFun,
                    parseToRule.fail || utils_1.voidFun,
                  )
                }
              }
            } else {
              var from = { path: '' }
              if (nextCall == null) {
                var toRoute = utils_1.routesForMapRoute(
                  router,
                  parseToRule.path,
                  ['finallyPathMap', 'pathMap'],
                )
                toRoute = utils_1.notRouteTo404(
                  router,
                  toRoute,
                  parseToRule,
                  navType,
                )
                parseToRule = __assign(
                  __assign(
                    __assign(__assign({}, toRoute), { params: {} }),
                    parseToRule,
                  ),
                  { path: toRoute.path },
                )
              ...
              hooks_1.transitionTo(
                ...
                hooks_2.HOOKLIST,
                function (callOkCb) {
                  uni[base_1.navtypeToggle[navType]](
                    parseToRule,
                    true,
                    callOkCb,
                    forceNav,
          ...
          function backOptionsBuild(router, level, animation) {
            ...
            var toRule = createRoute(
              router,
              level,
              undefined,
              __assign({ NAVTYPE: 'back' }, animation),
            )
            var navjumpRule = __assign(__assign({}, animation), {
              path: toRule.path,
              query: toRule.query,
              delta: level,
            })
              ...
              router.options.routerErrorEach(
                {
                  ...
                  level: 0,
                  msg:
                    '\u4E0D\u5B58\u5728\u7684\u9875\u9762\u6808\uFF0C\u8BF7\u786E\u4FDD\u6709\u8DB3\u591F\u7684\u9875\u9762\u53EF\u7528\uFF0C\u5F53\u524D level:0',
                },
                router,
              )
            }
          ...
          function createRoute(router, level, orignRule, uniActualData) {
            ...
            if (router.options.platform === 'h5') {
              ...
              var toQuery = query_1.parseQuery(
                __assign(
                  __assign({}, matRouteParams),
                  utils_1.copyData(vueRoute.query),
                ),
                router,
              )
              ...
              route.NAVTYPE =
                base_1.rewriteMethodToggle[vueRoute.type || 'reLaunch']
            } else {
              var appPage = {}
              if (orignRule != null) {
                appPage = __assign(__assign({}, orignRule), {
                  openType: orignRule.type,
                })
              } else {
                var page = utils_1.getUniCachePage(level)
                if (Object.keys(page).length === 0) {
                  var _NAVTYPE = uniActualData.NAVTYPE,
                    _args = __rest(uniActualData, ['NAVTYPE'])
                  var errorMsg =
                    '\u4E0D\u5B58\u5728\u7684\u9875\u9762\u6808\uFF0C\u8BF7\u786E\u4FDD\u6709\u8DB3\u591F\u7684\u9875\u9762\u53EF\u7528\uFF0C\u5F53\u524D level:' +
                    level
                  router.options.routerErrorEach(
                    {
                      type: 3,
                ...
                appPage = __assign(__assign({}, page.$page || {}), {
                  query: utils_1.deepDecodeQuery(pageOptions),
                  fullPath: decodeURIComponent(
                    (page.$page || {}).fullPath || '/' + page.route,
                  ),
                })
                if (router.options.platform !== 'app-plus') {
            ...
            var tableRoute = utils_1.routesForMapRoute(router, route.path, [
              'finallyPathMap',
              'pathMap',
            ])
  ...
  \****************************/
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
          ...
          function resetPageHook(router) {
            var proxyHookDeps = router.proxyHookDeps
            for (
              var _i = 0, _a = Object.entries(proxyHookDeps.hooks);
              _i < _a.length;
              _i++
            ) {
              var _b = _a[_i],
                resetHook = _b[1].resetHook
              resetHook()
            }
          }
          ...
          function queryPageToMap(toRule, router) {
            ...
            if (utils_1.getDataType(toRule) === '[object Object]') {
              ...
              if (objNavRule.path != null) {
                var _a = utils_1.urlToJson(objNavRule.path),
                  path = _a.path,
                  newQuery = _a.query
                route = utils_1.routesForMapRoute(router, path, [
                  'finallyPathList',
                  'pathMap',
                ])
                ...
                if (route == null) {
                  route = utils_1.getWildcardRule(router, {
                    type: 2,
                    msg:
                      '\u547D\u540D\u8DEF\u7531\u4E3A\uFF1A' +
                      objNavRule.name +
              ...
              route = utils_1.routesForMapRoute(router, toRule.path, [
                'finallyPathList',
                'pathMap',
              ])
              query = toRule.query
                ...
                hooks_1.ERRORHOOK[0](
                  {
                    type: 2,
                    msg:
                      '\u5F53\u6709\u8BBE\u7F6E alias\u6216\u8005aliasPath \u4E3A\u52A8\u6001\u8DEF\u7531\u65F6\uFF0C\u4E0D\u5141\u8BB8\u4F7F\u7528 path \u8DF3\u8F6C\u3002\u8BF7\u4F7F\u7528 name \u8DF3\u8F6C\uFF01',
                    route: route,
                  },
                  router,
                )
  ...
  \*******************************/
        ...
        /***/ (__unused_webpack_module, exports, __webpack_require__) => {
          ...
          var uniOrigin_1 = __webpack_require__(
            /*! ./uniOrigin */ './src/public/uniOrigin.ts',
          )
          var rewrite = [
            'navigateTo',
            'redirectTo',
            ...
            if (router.options.keepUniOriginNav === false) {
              rewrite.forEach(function (name) {
                ...
                uni[name] = function (params, originCall, callOkCb, forceNav) {
                  if (originCall === void 0) {
                    originCall = false
                  }
                  if (originCall) {
                    uniOrigin_1.uniOriginJump(
                      router,
                      oldMethod,
                      name,
                      params,
          ...
          function callRouterMethod(option, funName, router) {
            ...
            if (funName === 'navigateBack') {
              ...
              if (funName === 'switchTab') {
                var route = utils_1.routesForMapRoute(router, path, [
                  'pathMap',
                  'finallyPathList',
                ])
                var finallyPath = utils_1.getRoutePath(route, router)
                  .finallyPath
                ...
                if (router.options.platform === 'h5') {
                  ...
                  option.success = function () {
                    ...
                    userSuccess_1 === null || userSuccess_1 === void 0
                      ? void 0
                      : userSuccess_1.apply(null, args)
                    utils_1.timeOut(150).then(function () {
                      var cbArgs = option.detail || {}
                      if (
                        Object.keys(cbArgs).length > 0 &&
                        Reflect.has(cbArgs, 'index')
                      ) {
  ...
  \******************************/
        ...
        /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          var lifeCycle_1 = __webpack_require__(
            /*! ../helpers/lifeCycle */ './src/helpers/lifeCycle.ts',
          )
          var mixins_1 = __webpack_require__(
            /*! ../helpers/mixins */ './src/helpers/mixins.ts',
          )
          var methods_1 = __webpack_require__(
            /*! ../public/methods */ './src/public/methods.ts',
          )
          var rewrite_1 = __webpack_require__(
            /*! ../public/rewrite */ './src/public/rewrite.ts',
          )
          var AppReadyResolve = function () {}
          var AppReady = new Promise(function (resolve) {
            return (AppReadyResolve = resolve)
          })
          function createRouter(params) {
            ...
            var router = {
              ...
              $lockStatus: false,
              routesMap: {},
              lifeCycle: lifeCycle_1.registerRouterHooks(
                config_1.lifeCycle,
                options,
              ),
              push: function (to) {
              ...
              back: function (level, animation) {
                ...
                if (utils_1.getDataType(animation) !== '[object Object]') {
                  ...
                  if (!Reflect.has(animation, 'from')) {
                    animation = __assign(__assign({}, animation), {
                      from: 'navigateBack',
                    })
                  }
                }
                methods_1.lockNavjump(
                  level + '',
                  router,
                  'back',
                  undefined,
            ...
            utils_1.def(router, 'currentRoute', function () {
              return methods_1.createRoute(router)
            })
          ...
          function RouterMount(Vim, router, el) {
            ...
            if (utils_1.getDataType(router.mount) === '[object Array]') {
              ...
              throw new Error(
                '\u6302\u8F7D\u8DEF\u7531\u5931\u8D25\uFF0Crouter.app \u5E94\u8BE5\u4E3A\u6570\u7EC4\u7C7B\u578B\u3002\u5F53\u524D\u7C7B\u578B\uFF1A' +
                  typeof router.mount,
              )
            }
            if (router.options.platform === 'h5') {
  ...
  \*********************************/
        ...
        /***/ function (__unused_webpack_module, exports, __webpack_require__) {
          ...
          function uniOriginJump(
            ...
            var _a = formatOriginURLQuery(router, options, funName),
              complete = _a.complete,
              originRule = __rest(_a, ['complete'])
            var platform = router.options.platform
                        ...
                        switch (_e.label) {
                          case 0:
                            if (routerNavCount === 0) {
                              ...
                              if (platform !== 'h5') {
                                if (
                                  new RegExp(config_1.mpPlatformReg, 'g').test(
                                    platform,
                                  )
                                ) {
                                  // 跳转完成后小程序下还原生命周期
                                ...
                                router.Vue.prototype.$AppReady = true
                                if (platform === 'app-plus') {
                                  waitPage = plus.nativeObj.View.getViewById(
                                    'router-loadding',
                                  )
                                  waitPage && waitPage.close()
                                  launchedHook =
                                    (_a = router.options.APP) === null ||
                                    _a === void 0
                                      ? void 0
                                      : _a.launchedHook
                            ...
                            if (
                              ...
                              time =
                                (_b = router.options.applet) === null ||
                                _b === void 0
                                  ? void 0
                                  : _b.animationDuration
                            } else if (platform === 'app-plus') {
                              if (
                                funName === 'navigateBack' &&
                                lastNavType === 'navigateTo'
                              ) {
                                time =
                                  (_d =
                                    (_c = router.options.APP) === null ||
                                    _c === void 0
                                      ? void 0
                                      : _c.animation) === null || _d === void 0
                                    ? void 0
                                    : _d.animationDuration
                              }
                            }
                            if (
                              !(
          ...
          function formatOriginURLQuery(router, options, funName) {
            ...
            var queryURL =
              strQuery === '' ? path || url : (path || url) + strQuery
            var animationRule = {}
            if (router.options.platform === 'app-plus') {
              if (funName !== 'navigateBack') {
                animationRule =
                  ((_a = router.options.APP) === null || _a === void 0
                    ? void 0
                    : _a.animation) || {}
                animationRule = __assign(
                  __assign({}, animationRule),
                  animation || {},
                )
              }
            }
