<template>
  <view>
    ...
    <button type="primary" @click="switchTab(2)">
      插件switchTab对象path跳转
    </button>
    <button type="primary" @click="switchTab(3)">
      插件switchTab对象name跳转
    </button>
    <button type="primary" @click="switchTab(4)">
      插件switchTab字符串跳转
    </button>
    ...
    <button type="default" @click="redirectTo(2)">
      插件redirectTo对象path跳转
    </button>
    <button type="default" @click="redirectTo(3)">
      插件redirectTo对象name跳转
    </button>
    <button type="default" @click="redirectTo(4)">
      插件redirectTo字符串跳转
    </button>

    <button type="primary" @click="navigateTo(1)">原生navigateTo</button>
    <button type="primary" @click="navigateTo(2)">
      插件navigateTo对象path跳转
    </button>
    <button type="primary" @click="navigateTo(3)">
      插件navigateTo对象name跳转
    </button>
    <button type="primary" @click="navigateTo(4)">
      插件navigateTo字符串跳转
    </button>
    <button type="primary" @click="navigateTo(5)">
      插件navigateTo带动画跳转
    </button>
  </view>
</template>
      ...
      switch (type) {
        ...
        case 5:
          this.$router.push({
            ...
            animationType:
              openAnimation[~~(Math.random() * openAnimation.length - 1)],
            params: {
              name: '动画navigateTo',
              id: 110,
            },
      ...
      switch (type) {
        ...
        case 5:
          this.$router.back(1, {
            ...
            animationType:
              closeAnimation[~~(Math.random() * closeAnimation.length - 1)],
          })
          break
      }
    },
