...
export type hookListRule = Array<
  (
    router: Router,
    to: totalNextRoute,
    from: totalNextRoute,
...
export interface Router {
  ...
  replaceAll(
    to: totalNextRoute | navRoute | string,
    from?: totalNextRoute,
  ): void // 动态的导航到一个新 URL 关闭所有页面，打开到应用内的某个页面
